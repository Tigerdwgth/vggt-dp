#!/bin/bash
# Evaluate a trained VGGT-DP checkpoint.
#
# Usage:
#   bash scripts/eval_policy.sh <task_name> <exp_tag> <seed> <gpu_id> [eval_robovis] [robovis] [prio_as_cond] [visual_prio_training]
#
# Example (paper setting):
#   bash scripts/eval_policy.sh metaworld_hand-insert vggtdp 0 0 true true true true
